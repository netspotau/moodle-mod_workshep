...
Feature: Teacher can allocate submissions randomly or manually
  ...
  As a teacher
  I should be able to allocate workshep submissions randomly or manually
  ...
  Scenario: Teacher can allocate workshep submissions randomly
  ...
  Scenario: Teacher can allocate workshep submissions manually
    # Allocate submissions manually.
    Given I am on the "Workshep 1" "workshep activity" page logged in as teacher1
    When I allocate submissions in workshep "Workshep 1" as:
