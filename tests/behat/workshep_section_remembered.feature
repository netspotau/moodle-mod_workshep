@mod @mod_workshep
Feature: Workshep should remember collapsed/expanded sections in view page.
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | workshep | Workshep 1 | c1     | workshep1 |
  ...
  Scenario: Check section in view page can be remembered.
    ...
    When I change phase in workshep "Workshep 1" to "Submission phase"
