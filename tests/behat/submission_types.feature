...
Feature: Submission types
  ...
  Scenario: All submission fields required
    Given the following "activities" exist:
      ...
      | workshep | All required | TEST   | workshep1 | 2                  | 2                  |
    And I am on the "All required" "workshep activity" page
  ...
  Scenario: Online text required, file attachment optional
    Given the following "activities" exist:
      | activity | name          | course | idnumber  | submissiontypetext | submissiontypefile |
      | workshep | Optional file | TEST   | workshep1 | 2                  | 1                  |
    And I am on the "Optional file" "workshep activity" page
    And I follow "Switch to the submission phase"
    And I press "Continue"
    And I press "Add submission"
    And I set the field "Title" to "Test submission"
  ...
  Scenario: Online text optional, file attachment required
    Given the following "activities" exist:
      | activity | name          | course | idnumber  | submissiontypetext | submissiontypefile |
      | workshep | Optional text | TEST   | workshep1 | 1                  | 2                  |
    And I am on the "Optional text" "workshep activity" page
    And I follow "Switch to the submission phase"
    And I press "Continue"
    And I press "Add submission"
    And I set the field "Title" to "Test submission"
  ...
  Scenario: Online text only
    Given the following "activities" exist:
      | activity | name      | course | idnumber  | submissiontypetext | submissiontypefile |
      | workshep | Only text | TEST   | workshep1 | 2                  | 0                  |
    And I am on the "Only text" "workshep activity" page
    And I follow "Switch to the submission phase"
    And I press "Continue"
  ...
  Scenario: File attachment only
    Given the following "activities" exist:
      | activity | name      | course | idnumber  | submissiontypetext | submissiontypefile |
      | workshep | Only file | TEST   | workshep1 | 0                  | 2                  |
    And I am on the "Only file" "workshep activity" page
    And I follow "Switch to the submission phase"
    And I press "Continue"
    When I press "Add submission"
  ...
  Scenario: Neither submission type explicitly required
    Given the following "activities" exist:
      ...
      | workshep | Neither required | TEST   | workshep1 |
    And I am on the "Neither required" "workshep activity" page
    And I follow "Switch to the submission phase"
    And I press "Continue"
    And I press "Add submission"
    And I set the field "Title" to "Test submission"
