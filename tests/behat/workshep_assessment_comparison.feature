@mod @mod_workshep
Feature: Workshep assessment comparison
  In order to compare workshep assessments
  As a teacher
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | workshep | Workshep 1 | C1     | W1       | 2                  | 10    | 5            | 1             | 2                     |
  ...
  Scenario Outline: Teacher can set how strict the comparison of assessment is
    Given I am on the "Workshep 1" "workshep activity" page logged in as teacher1
    ...
    And I assess submission "Student1" in workshep "Workshep 1" as:
      | grade__idx_0            | 10 / 10   |
    And I am on the "Workshep 1" "workshep activity" page logged in as student3
    And I assess submission "Student1" in workshep "Workshep 1" as:
      | grade__idx_0            | 8 / 10    |
    And I am on the "Workshep 1" "workshep activity" page logged in as student4
    And I assess submission "Student1" in workshep "Workshep 1" as:
      | grade__idx_0            | 6 / 10    |
    And I am on the "Workshep 1" "workshep activity" page logged in as student5
    And I assess submission "Student1" in workshep "Workshep 1" as:
      | grade__idx_0            | 0 / 10    |
    When I am on the "Workshep 1" "workshep activity" page logged in as teacher1
