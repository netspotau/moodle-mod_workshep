...
Feature: Workshop grading strategy selection
  ...
  As a teacher
  I need to choose one of the four workshep grading strategies
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | workshep | C1     | Workshop 1 |
    And I am on the "Workshop 1" "workshep activity editing" page logged in as teacher1
