...
Feature: View work shop activity submissions report.
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | workshep | Music history | Test workshep description | C1     |

  Scenario Outline: Filter submissions report by last name/first name
    Given I am on the "Music history" "workshep activity" page logged in as teacher1
    When I change phase in workshep "Music history" to "<phase>"
  ...
  Scenario: Filter submissions report by last name/first name is hidden in the Setup phase.
    When I am on the "Music history" "workshep activity" page logged in as teacher1
