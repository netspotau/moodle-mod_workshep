...
Feature: Workshep submission and assessment with pass grade activity completion
  ...
  Background:
    ...
    When I am on the "TestWorkshep" "workshep activity" page logged in as teacher1
    ...
    # student2 submits
    And I am on the "TestWorkshep" "workshep activity" page logged in as student2
    And I add a submission in workshep "TestWorkshep" as:
      | Title              | Submission2  |
      | Submission content | Some content |
    # student3 submits
    And I am on the "TestWorkshep" "workshep activity" page logged in as student3
    And I add a submission in workshep "TestWorkshep" as:
      | Title              | Submission3  |
      | Submission content | Some content |
    ...
    And I am on the "TestWorkshep" "workshep activity" page
  ...
  @javascript
  Scenario: As teacher, I can see the completion status of students in the workshep activity
    And I am on the "Course1" course page logged in as student1
    And the "Receive a grade" completion condition of "TestWorkshep" is displayed as "done"
    And the "Receive a passing grade" completion condition of "TestWorkshep" is displayed as "failed"
    And I am on the "Course1" course page logged in as student2
    And the "Receive a grade" completion condition of "TestWorkshep" is displayed as "done"
    And the "Receive a passing grade" completion condition of "TestWorkshep" is displayed as "done"
    And I am on the "Course1" course page logged in as student3
    And the "Receive a grade" completion condition of "TestWorkshep" is displayed as "done"
    And the "Receive a passing grade" completion condition of "TestWorkshep" is displayed as "done"
    And I am on the "Course1" course page logged in as student4
    And the "Receive a grade" completion condition of "TestWorkshep" is displayed as "todo"
    And the "Receive a passing grade" completion condition of "TestWorkshep" is displayed as "todo"
    And I am on the "Course1" course page logged in as teacher1
    And "Sam1 Student1" user has completed "TestWorkshep" activity
    And "Sam2 Student2" user has completed "TestWorkshep" activity
    And "Sam3 Student3" user has completed "TestWorkshep" activity
    And "Sam4 Student4" user has not completed "TestWorkshep" activity
