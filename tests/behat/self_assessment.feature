@mod @mod_workshep
Feature: Workshep self-assessment
  ...
  Scenario: Student can assess their own submission
    ...
    And I assess submission "Student One" in workshep "TestWorkshep" as:
      | grade__idx_0            | 10 / 10                             |
    ...
    And I am on the TestWorkshep "workshep activity" page logged in as teacher1
    And I should see grade "80" for workshep participant "Student One" set by peer "Student One"
