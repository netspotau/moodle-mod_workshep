...
Feature: Setting grades to pass via workshep editing form
  ...
  Scenario: Adding a new workshep with grade to pass field set
    Given the following "activities" exist:
      ...
      | workshep   | Awesome workshep | c1     | workshep1   |
    When I am on the "Awesome workshep" "workshep activity editing" page logged in as teacher1
    And I set the field "Submission grade to pass" to "45"
    And I set the field "Assessment grade to pass" to "10.5"
    And I press "Save and return to course"
    And I am on the "Awesome workshep" "workshep activity editing" page
  ...
  Scenario: Grade to pass kept even with submission types without online text (MDL-64862)
    Given the following "activities" exist:
      ...
      | workshep | c1     | Another workshep | 42                  | 10.1             | 0                           |
    When I am on the "Course1" course page logged in as teacher1
    Then I should not see "New Workshep"
    And I am on the "Another workshep" "workshep activity editing" page
  ...
  Scenario: Adding a new workshep with grade to pass fields left empty
    Given the following "activities" exist:
      | activity   | name                     | course | idnumber    |
      | workshep   | Another awesome workshep | c1     | workshep1   |
    When I am on the "Another awesome workshep" "workshep activity editing" page logged in as teacher1
  ...
  Scenario: Adding a new workshep with non-numeric value of a grade to pass
    Given the following "activities" exist:
      ...
      | workshep   | Another awesome workshep | c1     | workshep1   | 1       |
    When I am on the "Another awesome workshep" "workshep activity editing" page logged in as teacher1
  ...
  Scenario: Adding a new workshep with invalid value of a grade to pass
    Given the following "activities" exist:
      | activity   | name                    | course | idnumber   | section |
      | workshep   | Almost awesome workshep | c1     | workshep1  | 1       |
    When I am on the "Almost awesome workshep" "workshep activity editing" page logged in as teacher1
  ...
  Scenario: Emptying grades to pass fields sets them to zero
    Given the following "activities" exist:
      | activity   | name                   | course | idnumber  | section |
      | workshep   | Super awesome workshep | c1     | workshep1 | 1       |
    When I am on the "Super awesome workshep" "workshep activity editing" page logged in as teacher1
    ...
    And I am on the "Super awesome workshep" "workshep activity editing" page
