...
/**
 * Contains unit tests for mod_workshep\dates.
 *
...
/**
 * Class for unit testing mod_workshep\dates.
 *
 * @copyright 2021 Shamim Rezaie <shamim@moodle.com>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
final class dates_test extends advanced_testcase {
     ...
     * @param int|null $submissionstart The 'Open for submissions from' value of the workshep.
     * @param int|null $submissionend The 'Submissions deadline' value of the workshep.
     * @param int|null $assessmentstart The 'Open for assessment from' value of the workshep.
     * @param int|null $assessmentend The 'Deadline for assessment' value of the workshep.
    ...
    public function test_get_dates_for_module(?int $submissionstart, ?int $submissionend,
        ...
        $this->setAdminUser();
        $workshep = $this->getDataGenerator()->create_module('workshep', $data);
