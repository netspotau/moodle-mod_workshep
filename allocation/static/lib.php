...
class workshep_static_allocator implements workshep_allocator {
    ...
    public function ui() {
        ...
        $allnames = \core_user\fields::get_name_fields(); // BASE-4184.
        ...
        if ($submissions) {
            ...
            $picturefields = \core_user\fields::for_userpic()->get_sql('r', false, '', 'reviewerid', false)->selects;
        ...
        if ($participants) {
            ...
            $namefields = \core_user\fields::for_name()->get_sql('e', true, '', '', false)->selects; // BASE-4184.
