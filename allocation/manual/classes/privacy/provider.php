...
/**
 * Provides the class {@link workshepallocation_manual\privacy\provider}
 *
...
class provider implements \core_privacy\local\metadata\provider, \core_privacy\local\request\user_preference_provider {
    ...
    public static function get_metadata(collection $collection) : collection {
        ...
        $collection->add_user_preference('workshepallocation_manual_perpage', 'privacy:metadata:preference:perpage');
    ...
    public static function export_user_preferences(int $userid) {
        ...
        $perpage = get_user_preferences('workshepallocation_manual_perpage', null, $userid);

        if ($perpage !== null) {
            writer::export_user_preference('workshepallocation_manual', 'workshepallocation_manual_perpage', $perpage,
                get_string('privacy:metadata:preference:perpage', 'workshepallocation_manual'));
        }
    }
}
