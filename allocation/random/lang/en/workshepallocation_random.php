...
/**
 * Strings for component 'workshepallocation_random', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['nogroupusers'] = '<p>Warning: If the workshep is in \'visible groups\' mode or \'separate groups\' mode, then users MUST be part of at least one group to have peer-assessments allocated to them by this tool. Non-grouped users can still be given new self-assessments or have existing assessments removed.</p>
