...
function xmldb_workshep_upgrade($oldversion) {
    ...
    if ($oldversion < 2020110901) {
        ...
        $table = new xmldb_table('workshep_grades');
        ...
        upgrade_mod_savepoint(true, 2020110901, 'workshep');
    ...
    if ($oldversion < 2025100601) {
        // Changing precision of field name on table workshep to (1333).
        $table = new xmldb_table('workshep');
        ...
        // Workshep savepoint reached.
        upgrade_mod_savepoint(true, 2025100601, 'workshep');
    }
