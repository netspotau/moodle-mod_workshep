 ...
 * @uses moodleform
 */
class workshep_numerrors_assessment_form extends workshep_assessment_form {
    ...
    protected function definition_inner(&$mform) {
        ...
        for ($i = 0; $i < $nodims; $i++) {
            // dimension header
            $dimtitle = get_string('dimensionnumber', 'workshepform_numerrors', $i+1);
            ...
            $label = get_string('dimensiongrade', 'workshepform_numerrors');
            ...
            ), 'group_grade__idx_' . $i, get_string('yourassessmentfor', 'workshep', $dimtitle), '<br />', false);
            $mform->addRule('group_grade__idx_' . $i, get_string('required'), 'required');

            // comment
            $label = get_string('dimensioncommentfor', 'workshepform_numerrors', $dimtitle);
