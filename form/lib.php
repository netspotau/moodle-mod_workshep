...
interface workshep_strategy {
     ...
     * are saved in workshepform_{strategyname} tables.
     *
     ...
     * If workshepid is null, it checks for any workshep instance. If workshepid is provided,
