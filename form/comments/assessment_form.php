 ...
 * @uses moodleform
 */
class workshep_comments_assessment_form extends workshep_assessment_form {
    ...
    protected function definition_inner(&$mform) {
        ...
        for ($i = 0; $i < $nodims; $i++) {
            // dimension header
            $dimtitle = get_string('dimensionnumber', 'workshepform_comments', $i+1);
            ...
            // comment
            $label = get_string('dimensioncommentfor', 'workshepform_comments', $dimtitle);
