 ...
 */
class backup_workshepform_accumulative_subplugin extends backup_subplugin {

    /**
     * Returns the assessment form definition to attach to 'workshep' XML element
     */
    protected function define_workshep_subplugin_structure() {
        ...
        // file annotations
        $subplugindimension->annotate_files('workshepform_accumulative', 'description', 'id');
    ...
    protected function define_referenceassessment_subplugin_structure() {
        return $this->dimension_grades_structure('workshepform_accumulative_referencegrade');
    }
    ...
    protected function define_exampleassessment_subplugin_structure() {
        return $this->dimension_grades_structure('workshepform_accumulative_examplegrade');
    }
    ...
    protected function define_assessment_subplugin_structure() {
        return $this->dimension_grades_structure('workshepform_accumulative_grade');
    }
