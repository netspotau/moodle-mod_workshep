...
class workshep_accumulative_strategy_testcase extends advanced_testcase {
    ...
    /** @var testable_workshep_accumulative_strategy instance of the strategy logic class being tested */
    protected $strategy;
 ...
 */
class testable_workshep_accumulative_strategy extends workshep_accumulative_strategy {
