...
/**
 * The mod_workshep submission assessments reset event.
 *
...
/**
 * The mod_workshep submission assessments reset event class.
 *
...
class assessments_reset extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' has reset the assessments for the workshep with the course module id " .
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'workshep', 'update clear assessments', 'view.php?id=' . $this->contextinstanceid,
    ...
    public static function get_name() {
        return get_string('eventsubmissionassessmentsreset', 'mod_workshep');
    }
