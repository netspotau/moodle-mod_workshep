 ...
 *
 *      - int previousworkshepphase: Previous workshep phase.
 *      - int targetworkshepphase: Target workshep phase.
 * }
 *
...
class phase_automatically_switched extends \core\event\base {
    ...
    public function get_description() {
        return "The phase of the workshep with course module id " .
            "'$this->contextinstanceid' has been automatically switched from " .
            "'{$this->other['previousworkshepphase']} to '{$this->other['currentworkshepphase']}'.";
    }
    ...
    public static function get_name() {
        return get_string('eventphaseautomaticallyswitched', 'mod_workshep');
    }
    ...
    protected function validate_data() {
        ...
        if (!isset($this->other['previousworkshepphase'])) {
            throw new \coding_exception('The \'previousworkshepphase\' value must be set in other.');
        }
        if (!isset($this->other['targetworkshepphase'])) {
            throw new \coding_exception('The \'targetworkshepphase\' value must be set in other.');
        }
    }

    /**
     * Map the objectid information in order to restore the event accurately. In this event
     * objectid is the workshep id.
     *
     * @return array
     */
