...
/**
 * Contains the class for fetching the important dates in mod_workshep for a given module instance and a user.
 *
...
/**
 * Class for fetching the important dates in mod_workshep for a given module instance and a user.
 *
 * @copyright 2021 Shamim Rezaie <shamim@moodle.com>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class dates extends activity_dates {
    ...
    /**
     * Returns a list of important dates in mod_workshep
     *
     * @return array
     */
    protected function get_dates(): array {
        ...
        if ($submissionstart) {
            ...
            $dates[] = [
                'label' => get_string($openlabelid, 'mod_workshep'),
        ...
        if ($submissionend) {
            ...
            $dates[] = [
                'label' => get_string($closelabelid, 'mod_workshep'),
